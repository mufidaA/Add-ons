...
export declare function downloadDirectory(sampleUrl: string, dstPath: string, concurrencyLimits?: number, retryLimits?: number): Promise<string[]>;
declare type SampleUrlInfo = {
    owner: string;
    repository: string;
    ref: string;
    dir: string;
