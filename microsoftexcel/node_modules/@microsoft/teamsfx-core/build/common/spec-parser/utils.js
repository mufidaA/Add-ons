...
exports.validateSpec = exports.listSupportedAPIs = exports.parseApiInfo = exports.generateParametersFromSchema = exports.isWellKnownName = exports.validateServer = exports.checkServerUrl = exports.resolveServerUrl = exports.getUrlProtocol = exports.convertPathToCamelCase = exports.getResponseJson = exports.getRelativePath = exports.updateFirstLetter = exports.isSupportedApi = exports.checkPostBody = exports.checkParameters = void 0;
...
function checkServerUrl(servers) {
    ...
    if (!protocol) {
        ...
        errors.push({
            ...
            content: util_1.format(constants_1.ConstantString.UrlProtocolNotSupported, protocol.slice(0, -1)),
            data: protocolString,
        });
    }
    return errors;
...
function validateSpec(spec, parser, isSwaggerFile) {
    ...
    if (refPaths.length > 1) {
        errors.push({
            ...
            content: util_1.format(constants_1.ConstantString.RemoteRefNotSupported, refPaths.join(", ")),
            data: refPaths,
        });
    }
    // No supported API
    ...
    if (apisMissingOperationId.length > 0) {
        warnings.push({
            ...
            content: util_1.format(constants_1.ConstantString.MissingOperationId, apisMissingOperationId.join(", ")),
