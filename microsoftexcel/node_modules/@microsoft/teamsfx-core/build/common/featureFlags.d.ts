...
export declare function isApiCopilotPluginEnabled(): boolean;
export declare function isCliNewUxEnabled(): boolean;
export declare function isCliV3Enabled(): boolean;
export declare function isTestToolEnabled(): boolean;
