...
exports.isTestToolEnabled = exports.isCliV3Enabled = exports.isCliNewUxEnabled = exports.isApiCopilotPluginEnabled = exports.isCopilotPluginEnabled = exports.isImportSPFxEnabled = exports.isVideoFilterEnabled = exports.isV3Enabled = exports.isCLIDotNetEnabled = exports.initializePreviewFeatureFlags = exports.isFeatureFlagEnabled = void 0;
...
function isApiCopilotPluginEnabled() {
    ...
    return isFeatureFlagEnabled(constants_1.FeatureFlagName.ApiCopilotPlugin, false) && isCopilotPluginEnabled();
}
...
function isCliV3Enabled() {
    return isFeatureFlagEnabled("TEAMSFX_CLI_V3", false);
}
exports.isCliV3Enabled = isCliV3Enabled;
function isTestToolEnabled() {
    return isFeatureFlagEnabled(constants_1.FeatureFlagName.TestTool, false);
}
exports.isTestToolEnabled = isTestToolEnabled;
