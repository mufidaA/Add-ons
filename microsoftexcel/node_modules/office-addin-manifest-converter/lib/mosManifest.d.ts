...
export declare class Parameters2 implements IParameters2 {
    name: string;
    inputType: Parameters2InputType;
    title: string;
    description: string;
    value: string;
    choices: Choices2[];
...
export declare class TaskInfo2 implements ITaskInfo2 {
    title: string;
    width: string;
    height: string;
    url: string;
    constructor(data?: ITaskInfo2);
    init(_data?: any): void;
    static fromJS(data: any): TaskInfo2;
    toJSON(data?: any): any;
}
export interface ITaskInfo2 {
    title: string;
    width: string;
    height: string;
    url: string;
...
export declare enum Parameters2InputType {
    Text = "text",
    Textarea = "textarea",
    Number = "number",
    Date = "date",
...
export declare class Choices2 implements IChoices2 {
    title: string;
    value: string;
    constructor(data?: IChoices2);
    init(_data?: any): void;
    static fromJS(data: any): Choices2;
    toJSON(data?: any): any;
}
export interface IChoices2 {
    title: string;
    value: string;
}
